  ...
  return (
    <div className="Container-1">
      <div className="title">
        ...
        <p>
          Transparency in action. See how we are working together to improve our
          city
        </p>
      </div>
      <div className="Data">
      ...
      <div className="Speed">
        ...
        <div className="More-data">
          ...
          <p>
            {" "}
            We do our work based on the based on dashboard that is controlled by
            citizen. Every report you file helps our maintences crews proritize
